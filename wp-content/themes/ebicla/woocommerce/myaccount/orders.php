							...
							<?php elseif ( 'order-actions' === $column_id ) : ?>
								...
								if ( ! empty( $actions ) ) {
									foreach ( $actions as $key => $action ) {
                                        ...
                                        } elseif (sanitize_html_class( $key ) == 'invoice') {
                                            $icon = '<i class="fas fa-file-invoice"></i>';
                                        }
										echo '<a href="' . esc_url( $action['url'] ) . '" class="woocommerce-button button ' . sanitize_html_class( $key ) . '">' . $icon . '<span class="text">' . esc_html( $action['name'] ) . '</span></a>';
									}
								}
								?>
							<?php endif; ?>
